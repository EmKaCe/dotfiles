# Generated by Powerlevel10k configuration wizard on 2024-01-21 at 13:55 CET.
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    ...
    context_joined          # user@hostname (no seperator)
  ...
  typeset -g POWERLEVEL9K_BATTERY_{CHARGING,CHARGED}_FOREGROUND=28
